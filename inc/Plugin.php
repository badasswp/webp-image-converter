...
final class Plugin {
	...
	public function run(): void {
		...
		add_action( 'wp_generate_attachment_metadata', [ $this, 'generate_webp_srcset_images' ], 10, 3 );
	}
	 ...
	 * @return mixed[]
	 */
	public function generate_webp_srcset_images( $data, $attachment_id, $context ) {
